...
# for sparsity in 88 76 64 52 40
# do
# python run_benchmark.py \
#         --model meta-llama/Llama-2-13b-hf \
#         --sliced-model-path /raid0-data/yifan/out_models/llama-2-13b/no_QK/Llama-2-13b-hf_$sparsity \
#         --device cuda:0 \
#         --ntokens 64 \
#         --batch-size 256 \
#         --eval-dataset $dataset
...
# python run_benchmark.py \
#         --model meta-llama/Llama-2-13b-hf \
#         --sliced-model-path /raid0-data/yifan/out_svdllm/checkpoints/svd_llm_llama_2_13b_$sparsity/model.pt \
#         --device cuda:0 \
#         --ntokens 64 \
#         --batch-size 256 \
#         --eval-dataset $dataset
...
python run_benchmark.py \
        --model meta-llama/Llama-2-13b-hf \
        --sliced-model-path /raid0-data/yifan/out_slicegpt/llama-2-13b/$dataset/Llama-2-13b-hf_$sparsity \
        --device cuda:0 \
        --ntokens 64 \
        --batch-size 256 \
        --eval-dataset $dataset
